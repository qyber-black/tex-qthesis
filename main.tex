...
% Other options are passed to the underlying book class.
...
% For unnumbered chapters (Dedication, Acknowledgements, Declaration, Publications,
% data and code, etc.) use \chapter*{Title} and \addcontentsline{toc}{chapter}{Title}
% so they appear in TOC.
%
% -----------------------------------------------------------------------------
...
% =============================================================================
\documentclass[mixed,oneside,numeric]{qthesis}
...
% Alternative (traditional): \usepackage{booktabs}  % \toprule, \midrule, \bottomrule
...
\maketitle{%
  This is the abstract: a short, self-contained summary of the thesis (maximum
  300 words). It should state the problem, methods, and main contributions
  so that a reader can understand the scope without reading the full document.
  The \texttt{qthesis} class typesets it as an unnumbered chapter and adds it to
